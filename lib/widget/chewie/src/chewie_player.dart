...
import 'package:video_interactive/widget/chewie/src/player_with_controls.dart';
...
class ChewieState extends State<Chewie> {
  ...
  void listener() async {
    if (widget.controller.isFullScreen && !_isFullScreen) {
      ...
      await _pushPortraitScreenWidget(context);
  ...
  Future<dynamic> _pushPortraitScreenWidget(BuildContext context) async {
